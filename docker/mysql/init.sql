...
CREATE TABLE `jobs` (
    ...
    `accept_count` int(11) unsigned NOT NULL,
...
INSERT INTO `jobs`
(`suburb_id`, `category_id`, `accept_count`, `contact_name`, `contact_phone`, `contact_email`, `price`, `description`)
VALUES
(1, 1, 1, 'Luke Skywalker', '0412345678', 'luke@mailinator.com', 20, 'Integer aliquam pulvinar odio et convallis. Integer id tristique ex. Aenean scelerisque massa vel est sollicitudin vulputate. Suspendisse quis ex eu ligula elementum suscipit nec a est. Aliquam a gravida diam. Donec placerat magna posuere massa maximus vehicula. Cras nisl ipsum, fermentum nec odio in, ultricies dapibus risus. Vivamus neque.'),
(2, 2, 0, 'Darth Vader', '0422223333', 'darth@mailinator.com', 30, 'Praesent elit dui, blandit eget nisl sed, ornare pharetra urna. In cursus auctor tellus. Quisque ligula metus, viverra nec nibh ut, sagittis luctus tellus. Nulla egestas nibh ut diam vehicula, ut auctor lectus pharetra. Aliquam condimentum, erat eget vehicula eleifend, nulla risus consequat augue, quis convallis mi diam et dui.'),
